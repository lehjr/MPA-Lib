...
public class ChargingBaseContainer extends Container {
    ...
    public ChargingBaseContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModObjects.CHARGING_BASE_CONTAINER_TYPE.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity, ModObjects.CHARGING_BASE_BLOCK.get());
    }
