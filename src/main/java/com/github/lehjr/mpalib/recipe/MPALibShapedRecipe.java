...
import com.github.lehjr.minecraft.JsonToNBTFixed;
...
public class MPALibShapedRecipe extends ShapedRecipes {
    private static final Gson GSON = new GsonBuilder().setPrettyPrinting().disableHtmlEscaping().create();

    public MPALibShapedRecipe(final String group, final int width, final int height, final NonNullList<Ingredient> ingredients, final ItemStack result) {
        super(group, width, height, ingredients, result);
    }

    public static MPALibShapedRecipe deserialize(JsonContext context, JsonObject json) {
        ...
        return new MPALibShapedRecipe(s, i, j, nonnulllist, itemstack);
    }
