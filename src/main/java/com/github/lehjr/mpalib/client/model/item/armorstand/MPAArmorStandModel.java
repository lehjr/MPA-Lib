package com.github.lehjr.mpalib.client.model.item.armorstand;
...
@OnlyIn(Dist.CLIENT)
public class MPAArmorStandModel extends MPAArmorStandArmorModel {
    /**
     * A constant instance of the armor stand texture
     */
    public static final ResourceLocation TEXTURE_ARMOR_STAND = new ResourceLocation(MPALIbConstants.MOD_ID, "textures/models/armorstand.png");
    ...
    public MPAArmorStandModel() {
        this(0.0F);
    }

    public MPAArmorStandModel(float modelSize) {
        ...
        this.standBase.addBox(-8.0F, 11.0F, -8.0F, 16.0F, 1.0F, 16.0F, 0.0F, 0.0F, 0.0F);
    ...
    public void hideBase() {
        this.standBase.showModel = false;
    }

    @Override
    public void showBase() {
        this.standBase.showModel = true;
    }
