...
@OnlyIn(Dist.CLIENT)
public class MPAArmorStandArmorModel extends BipedModel<MPAArmorStandEntity> {
    public MPAArmorStandArmorModel(float modelSize) {
        this(modelSize, 64, 32);
    }

    protected MPAArmorStandArmorModel(float modelSize, int textureWidthIn, int textureHeightIn) {
