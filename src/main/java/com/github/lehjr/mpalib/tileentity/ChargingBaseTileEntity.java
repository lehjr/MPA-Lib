...
import com.github.lehjr.mpalib.capabilities.TileEnergyStorage;
import com.github.lehjr.mpalib.capabilities.TileEnergyWrapper;
...
public class ChargingBaseTileEntity extends MPALibTileEntity implements ITickableTileEntity {
    public ChargingBaseTileEntity() {
        super(ModObjects.CHARGING_BASE_TILE.get());
    }
    ...
    private TileEnergyStorage createEnergy() {
        return new TileEnergyStorage(MPALibSettings.chargingBaseMaxPower(), MPALibSettings.chargingBaseMaxPower()) {
            @Override
