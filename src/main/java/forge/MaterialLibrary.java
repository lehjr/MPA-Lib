    ...
    public MaterialLibrary(LineReader reader) throws IOException {
        ...
        while ((line = reader.readAndSplitLine(true)) != null) {
            switch (line[0]) {
                ...
                case "Ka":
                    currentMaterial.ambientColor = MPAOBJModel.parseVector4(line);
                    break;
                ...
                case "Kd":
                    currentMaterial.diffuseColor = MPAOBJModel.parseVector4(line);
                    break;
                ...
                case "Ks":
                    currentMaterial.specularColor = MPAOBJModel.parseVector4(line);
                    break;
