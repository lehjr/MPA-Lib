 ...
 */
    ...
    MPAOBJModel(LineReader reader, ModelSettings settings) throws IOException {
        ...
        if (materialLibraryOverrideLocation != null) {
            ...
            if (lib.contains(":")) {
                mtllib = MPAOBJLoader.INSTANCE.loadMaterialLibrary(new ResourceLocation(lib));
            } else {
                mtllib = MPAOBJLoader.INSTANCE.loadMaterialLibrary(new ResourceLocation(modelDomain, modelPath + lib));
            }
        }
